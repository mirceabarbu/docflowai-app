...
function renderList() {
  ...
  list.forEach((n, i) => {
    ...
    card.innerHTML = `
      ...
      <button class="notif-del" title="Șterge" onclick="deleteNotif(event,${n.id})"><svg class="df-ic" viewBox="0 0 24 24" style="width:14px;height:14px;"><use href="/icons.svg?v=3.9.470#ico-x"/></svg></button>
    `;
