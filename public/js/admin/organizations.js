  ...
  function renderOrgsTable(orgs) {
    ...
    tbody.innerHTML = orgs.map(org => {
      ...
      const actions = isDeactivated
        ...
        : `<button class="df-action-btn sm" onclick="event.stopPropagation();openOrgDetail(${org.id})" title="Detalii"><svg class="df-ic"><use href="/icons.svg?v=3.9.470#ico-settings"/></svg></button>
