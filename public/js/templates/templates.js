...
function buildCard(t,idx) {
  ...
  const shareBtnContent = t.shared
    ? '<svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.471#ico-shield"/></svg>Fă privat'
    : '<svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.471#ico-building"/></svg>Share';
  const actions = t.isOwner ? `
    <button class="df-action-btn sm" onclick='openEdit(${JSON.stringify(t)})'><svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.471#ico-edit"/></svg>Editează</button>
    <button class="df-action-btn sm" onclick="toggleShared(${t.id},${t.shared})">${shareBtnContent}</button>
    <button class="df-action-btn danger sm" onclick="deleteTemplate(${t.id},'${esc(t.name)}')"><svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.471#ico-trash"/></svg>Șterge</button>
    <button class="df-action-btn sm" onclick="copyTemplate(${t.id})"><svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.471#ico-clipboard"/></svg>Copiază</button>`
  : `<button class="df-action-btn success sm" onclick="copyTemplate(${t.id})"><svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.471#ico-clipboard"/></svg>Copiază ca al meu</button>`;
  div.innerHTML=`
    ...
    <div class="tmpl-actions">
      <button class="df-action-btn cta sm" onclick="useTemplate(${t.id})"><svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.471#ico-play"/></svg>Folosește</button>
      ${actions}
    </div>`;
  return div;
}
