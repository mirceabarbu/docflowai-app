...
<div class="dfem-overlay" id="dfem-overlay" role="dialog" aria-modal="true" aria-labelledby="dfem-title">
  <div class="dfem-dialog">
    ...
    <div class="dfem-title" id="dfem-title">
      <svg class="df-ico df-ico-lg" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.469#ico-mail"/></svg>
    ...
    <div class="dfem-form">
      ...
      <div class="dfem-field">
        <label class="dfem-label">
          <svg class="df-ico df-ico-sm" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.469#ico-paperclip"/></svg>
      ...
      <button class="dfem-submit" id="dfem-submit" type="button">
        <svg viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.469#ico-send"/></svg>
