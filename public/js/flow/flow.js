        ...
        reviewCard.innerHTML = `
          ...
          <div style="margin-top:12px;">
            ...
            <div style="display:flex;gap:10px;align-items:center;margin-bottom:10px;flex-wrap:wrap;">
              <button type="button" onclick="document.getElementById('reviewPdfInput').click()" class="df-action-btn"><svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.474#ico-folder"/></svg>Alege fișier</button>
              <span id="reviewPdfName" style="color:var(--muted);font-size:.83rem;">Niciun fișier selectat</span>
            </div>
            <button id="btnUploadReviewPdf" class="df-action-btn success"><svg class="df-ic" viewBox="0 0 24 24"><use href="/icons.svg?v=3.9.474#ico-upload-cloud"/></svg>Trimite documentul revizuit și repornește fluxul</button>
