/**
 * Admin routes — flows management (archive, clean, list, audit).
 * DocFlowAI — server/routes/admin/flows.mjs
 */

import { Router } from 'express';
import { csrfMiddleware } from '../../middleware/csrf.mjs';
import { requireAuth } from '../../middleware/auth.mjs';
import { escHtml } from '../../middleware/auth.mjs';
import { pool, requireDb, saveFlow, getFlowData } from '../../db/index.mjs';
